    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberLanguages", x => new { x.LanguageId, x.MemberId });
                    table.ForeignKey(
                        name: "FK_MemberLanguages_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberLocations", x => new { x.MemberId, x.LocationId });
                    table.ForeignKey(
                        name: "FK_MemberLocations_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberLanguages_MemberId",
                table: "MemberLanguages",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberLocations_LocationId",
